...
export default function ReceivePage() {
  ...
  return (
    <PageSection id="rx-apps" title="Receive Apps" subtitle="All 29 receive-only applications in Mayhem firmware. Safe to use — no transmission involved." icon={SignalIcon} badge={<SafetyBadge level="safe" />}>
