    ...
    <div className="flex">
      ...
      <main id="main-content" role="main" className="lg:ml-56 flex-1 p-6 max-w-6xl mx-auto">
        ...
        <footer className="text-center text-xs text-base-content/20 py-8 font-mono tracking-wide">
          ...
          <p className="mt-3 text-base-content/20 text-[10px]">A <a href="https://superbasic.studio/opensource" target="_blank" rel="noopener noreferrer" className="text-green-500 hover:text-green-400 transition-colors underline underline-offset-2">Super Basic Studio</a> open-source project</p>
        </footer>
      </main>
    </div>
  );
